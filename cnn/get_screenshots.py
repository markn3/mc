...
CAVE_PATH = "C:\\Users\\markn\\Desktop\\mc\\CNN\\cnn\\MineRLBasaltFindCave-v0"
...
for vid in onlyfiles:
    ...
    VID_PATH = "C:\\Users\\markn\\Desktop\\mc\\CNN\\cnn\\MineRLBasaltFindCave-v0\\" + str(vid)
    ...
    cam.set(cv2.CAP_PROP_POS_FRAMES, length*.90)
    ...
    while(True):
        ...
        if ret:
            ...
            if(currentframe % 20 == 0):
                ...
                name = './data/frame' + str(currentframe) + '_' +str(current_vid) + '_b.jpg'
                print ('Creating...' + name)
